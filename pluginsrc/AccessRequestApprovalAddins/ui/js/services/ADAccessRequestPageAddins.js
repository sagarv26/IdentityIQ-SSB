/* will execute the function on script load */
	jQuery(document).ready(function(){
		showADprovisioningFormAccessRequestPage();
	});


// handles the path change event and invokes the function
window.addEventListener('popstate', showADprovisioningFormAccessRequestPage);


//==================================================
/* function to display secret management link in the AD provisioning form page */ 
	function showADprovisioningFormAccessRequestPage(){
	
		if(window.location.href.indexOf('/identityiq/accessRequest/accessRequest.jsf#/accessRequest/review') !== -1){
