/* will execute the function on script load */
	jQuery(document).ready(function(){
		showADRequestProvFormAddin();
	});

	
//==================================================
/* function to display secret management link in the AD provisioning form page */
	function showADRequestProvFormAddin(){
	
		if(window.location.href.indexOf('/identityiq/workitem/commonWorkItem.jsf#/commonWorkItem/') !== -1){
